...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/AnneClaude/Time-mangement-app.git](https://github.com/AnneClaude/Time-mangement-app.git)
...
* Register the Android app using your package name.
* Download the google-services.json file and place it in the app/ directory of this project.
  
4.Build and Run:
* Sync the Gradle files.
* Select a physical device or an emulator and click Run. 
